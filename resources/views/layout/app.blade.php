    ...
    <div class="bg-gray-700 text-gray-300 flex justify-between p-3">
        ...
        <div class="hidden md:inline">
            <nav>
                @auth
                    @if (Auth::user()->role == '1')
                        <a href="{{ route('admin.dashboard') }}"  class=" tracking-wide hover:bg-gray-300 hover:text-gray-700 py-3 px-5 rounded">Dashboard</a>
                  
                    @else
                        <a href="{{ route('dashboard') }}"  class=" tracking-wide hover:bg-gray-300 hover:text-gray-700 py-3 px-5 rounded">Dashboard</a>
                        
                    @endif
                @endauth
                @guest
                 <a href="{{ route('login') }}"  class=" tracking-wide hover:bg-gray-300 hover:text-gray-700 py-3 px-5 rounded">Log in</a>
                    <a href="{{ route('register') }}"  class=" tracking-wide hover:bg-gray-300 hover:text-gray-700 py-3 px-5 rounded">Register</a>
                @endguest
            </nav>
        </div>
